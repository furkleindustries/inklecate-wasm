...
let asm = ModuleClass.asm = ModuleClass.asm(ModuleClass.asmGlobalArg, ModuleClass.asmLibraryArg, buffer);
...
class ExitStatus extends Error {
  ...
  public readonly message = `Program terminated with exit(${status}).`;
